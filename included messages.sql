...
INSERT INTO `activityhistory` VALUES (1,'To Kill a Mockingbird','Borrow','2024-01-01',NULL,'2024-01-16',1),(1,'To Kill a Mockingbird','Return','2024-01-16','1',NULL,2),(3,'Jane Eyre','Borrow','2024-02-02',NULL,NULL,3),(2,'1984','Borrow','2025-01-07',NULL,'2025-01-21',4),(2,'The Hobbit','Borrow','2025-01-07',NULL,'2025-01-21',5),(2,'1984','Borrow','2025-01-10',NULL,'2025-01-24',6),(5,'1984','Reservation','2025-01-13',NULL,NULL,7),(5,'War and Peace','Reservation','2025-01-13',NULL,NULL,12),(2,'War and Peace','Borrow','2025-01-10',NULL,'2025-01-24',13),(2,'War and Peace','Return','2025-01-13','Returned on time',NULL,14),(5,'War and Peace','Borrow','2025-01-13',NULL,'2025-01-27',15);
...
INSERT INTO `books` VALUES ('1984','0','15','Science Fiction',NULL,'George Orwell',1,'A'),('Harry Potter and the Sorcerer\'s Stone','10','25','	Fantasy',NULL,'J. K. Rowling',2,'A'),('Moby Dick','3','6','	Adventure',NULL,'Herman Melville',3,'A'),('Pride and Prejudice','6','12','Romantic Novel',NULL,'Jane Austen',4,'A'),('The Catcher in the Rye','4','8','Fiction',NULL,'J.D. Salinger',5,'A'),('The Great Gatsby','8','20','Drama',NULL,'	F. Scott Fitzgerald',6,'A'),('The Hobbit','9','18','	Fantasy',NULL,'J. R. R. Tolkien',7,'A'),('The Lord of the Rings','7','14','	Fantasy',NULL,'J. R. R. Tolkien',8,'A'),('To Kill a Mockingbird','5','10','Drama',NULL,'	Harper Lee',9,'A'),('War and Peace','0','5','Drama',NULL,'	Leo Tolstoy',10,'A');
...
INSERT INTO `librarian` VALUES (1,'1','1','1');
...
INSERT INTO `orders` VALUES ('2025-01-13','1984',5,'2025-01-13');
...
INSERT INTO `subscriber` VALUES (1,'dor','','','frozen',NULL),(2,'John Doe','123-456-7890','john.doe@example.com','active','123'),(3,'Jane Smith','987-654-3210','jane.smith@example.com','active',NULL),(4,'Alice Johnson','555-666-7777','alice.johnson@example.com','active',NULL),(5,'1','1','1','active','1');
...
-- Dump completed on 2025-01-13 17:33:14
