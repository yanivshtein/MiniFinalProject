...
public class ViewHistoryGUI {
	...
	public void initialize() {
		...
		for (int i = 0; i < activityHistory.size(); i++) {
			...
			// Here, I'm assuming you have a structured format like "Book Name: <book_name>,
			// Action: <action>, ..."
			// If you have specific structure, you can split and format accordingly. Example
			// below:
	...
	/**
	 * Handles the action for the "View" button. Sends a request to the server to
	 * retrieve the user's activity history and displays it in the text area.
	 *
	 * @param event the action event triggered by clicking the "View" button.
	 * @throws IOException if an error occurs while communicating with the server or
	 *                     updating the UI.
	 */
