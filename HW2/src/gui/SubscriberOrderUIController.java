...
public class SubscriberOrderUIController {
	...
	public void getSendBtn(ActionEvent event) throws IOException {
		...
		ClientUI.chat.acceptFromOrderController(5, ClientGUILandController.id, "");
		if (ChatClient.isFrozen == true) {
			errorMsg.setContentText("Account is FROZEN!");
			return; // exit the method
		}
		ClientUI.chat.acceptFromOrderController(6, bookNameGot, "");
		...
		ClientUI.chat.acceptFromOrderController(7, ClientGUILandController.id, bookNameGot);
